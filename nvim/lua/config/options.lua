...
g.loaded_netrw = 1       -- disable netrw, which is a built-in file explorer that can conflict with nvim-tree
g.loaded_netrwPlugin = 1      -- disable netrwPlugin, which is a built-in file explorer that can conflict with nvim-tree
